...
{% callout "Keyboard user?" %}If you are using a keyboard, you can press a number key to activate the corresponding theme based on the theme picker order. (the current theme index  and `0` revert to the system default).{% endcallout %}
