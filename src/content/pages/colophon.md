...
Also, I did use a handful of SVG icons from [Lucide](https://lucide.dev/icons/), listed here: `arrow-right-left`, `folder-tree`, `gamepad-2`, `globe`, `package-plus`, `square-check-big`, `star`, and `trophy`.
