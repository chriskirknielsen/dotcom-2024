...
tags: [eleventy, notion, api, cache]
toc: true
time: '03:00:00'
featured: true
---
...
{{ set imageUrl = "./notion-grid.png" |> toRoot }}
{{ image imageUrl, "A few rows in a Grid in Notion with a lot of columns, such as Sort Title, Platform, Format, Number of discs…", "Quite a handful of columns!", { width: 1280, height: 192 } }}

{{ callout "Free idea" }}If you’re starting from scratch, you could invert this process and use the results from the PSN API to add new data to a database via the Notion API instead.{{ /callout }}
