...
Remember to kern only when you have adjusted the tracking for each glyph, to reduce the amount of work needed on the kerning bit. Kerning too early will result in repeated work, which… I know nothing about.
